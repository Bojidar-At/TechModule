...
namespace _04.DistanceBetweenPoint
{
    class DistanceBetweenPoint
    {
        static void Main(string[] args)
        {
            ...
            Point[] closestPoint = FindClosestPoint(points);
        ...
        static Point[] FindClosestPoint (Point[] points)
        {
            ...
            for (int p1 = 0; p1 < points.Length; p1++)
            {
                for (int p2 = p1+1; p2 < points.Length; p2++)
                {
                    ...
                    if(distance<minDistance)
                    {
                        ...
                        closestPoint = new Point[] { points[p1], points[p2] };
                    }
                }
            }
            return closestPoint;
